...
\subsection{Generadores de analizadores léxicos: PLY}

Herramientas como PLY (Python Lex-Yacc) permiten definir tokens mediante expresiones regulares y generar automáticamente el scanner. El siguiente fragmento muestra la definición de tokens para una calculadora simple.

\begin{lstlisting}[style=python, caption={Definición de tokens con PLY}]
